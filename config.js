...
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '237697517505';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'Primo';
global.pairingNumber = process.env.BOT_NUMBER || '237697517505';  // put your number here
